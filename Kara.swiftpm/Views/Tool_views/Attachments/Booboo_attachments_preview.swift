...
public struct Booboo_attachments_preview: View {
    
    //MARK: Data properties
    @Binding public var appointments : [Appointment]
    private var photoData : [Data] {
        return appointments.flatMap{$0.attachmentsData}
    }
    ...
    public var body: some View {
        ...
        .fullScreenCover(isPresented: $showAttachmentList) {
            NavigationView {
                Booboo_attachments_list(photoData: photoData)
            }
        }
    }
